...
void QSM::mesh_cylinder(std::vector<std::array<double,3>>& vertices, int resolution) const
{
  vertices.clear();
...
void QSM::tmesh_cylinder(std::vector<std::array<double,3>>& vertices, std::vector<std::array<int,3>>& faces, int resolution) const
{
  mesh_cylinder(vertices, resolution);
...
void QSM::qmesh_cylinder(std::vector<std::array<double,3>>& vertices, std::vector<std::array<int,4>>& faces, int resolution) const
{
  mesh_cylinder(vertices, resolution);
