 ...
 */
void QSM::mesh_continuous(std::vector<std::array<double,3>>& vertices, std::vector<std::array<int,4>>& faces, int resolution) const
{
  vertices.clear();
  faces.clear();
...
void QSM::qmesh_continuous(std::vector<std::array<double,3>>& vertices, std::vector<std::array<int,4>>& faces, int resolution) const
{
  mesh_continuous(vertices, faces, resolution);
}

void QSM::tmesh_continuous(std::vector<std::array<double,3>>& vertices, std::vector<std::array<int,3>>& faces, int resolution) const
{
  std::vector<std::array<int,4>> quad_faces;
  mesh_continuous(vertices, quad_faces, resolution);
