...
points1 <- matrix(c(0, 1, 0,
                    ...
                    -1, 0, 0),
                  ncol = 3, byrow = TRUE)
result1 <- arbor:::fit_circle_on_3_points(points1)
...
points2 <- matrix(c(0, 2, 0,   # Point 1
                    ...
                    -sqrt(3), -1, 0), # Point 3
                  ncol = 3, byrow = TRUE)
result2 <- arbor:::fit_circle_on_3_points(points2)
...
points3 <- matrix(c(0, 0, 0,   # Point 1
                    ...
                    2, 2, 0),  # Point 3
                  ncol = 3, byrow = TRUE)
result3 <- arbor:::fit_circle_on_3_points(points3)
...
points4 <- matrix(c(5, 5, 0,   # Point 1
                    ...
                    5, 10, 0), # Point 3
                  ncol = 3, byrow = TRUE)
result4 <- arbor:::fit_circle_on_3_points(points4)
...
points5 <- matrix(c(2, 5, 0,   # Point 1
                    ...
                    -1, 2, 0), # Point 3
                  ncol = 3, byrow = TRUE)
result5 <- arbor:::fit_circle_on_3_points(points5)
...
points6 <- matrix(c(0, 0.1, 0,   # Point 1
                    ...
                    -0.1, 0, 0),  # Point 3
                  ncol = 3, byrow = TRUE)
result6 <- arbor:::fit_circle_on_3_points(points6)
...
result8 <- arbor:::ransac_circle_cpp(circle_points, num_iterations = 400, early_exit = 1)
...
result9 <- arbor:::ransac_circle_cpp(circle_points, num_iterations = 400, early_exit = 0.8)
